...
import { Link, FormControl, Label, Join } from "..";
import { Footer } from ".";
    ...
    return (
      <Footer {...args}>
        ...
        <form>
          ...
          <FormControl as="fieldset" className="w-80">
            <Label>
              <Label.Text>Enter your email address</Label.Text>
            </Label>
            <Join>
              <Join.Input placeholder="username@site.com" />
              <Join.Button color="primary">Subscribe</Join.Button>
            </Join>
          </FormControl>
        </form>
      </Footer>
...
export const WithCopyrightTextAndSocialIcons: Story = {
  args: {
    className: "items-center p-4 bg-neutral text-neutral-content",
  },
  render: (args) => {
    return (
      <Footer {...args}>
...
export const With2Rows: Story = {
  args: {
    className: "grid-rows-2 bg-neutral text-neutral-content",
  },
  render: (args) => {
    return (
      <Footer {...args}>
  ...
  render: (args) => {
    return (
      <div className="w-full">
        <Footer {...args} className="bg-base-200 text-base-content">
          <nav>
            <Footer.Title>Services</Footer.Title>
            <Link hover>Branding</Link>
            <Link hover>Design</Link>
