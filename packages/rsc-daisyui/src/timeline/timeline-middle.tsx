...
export type TimelineMiddleComponent = React.ForwardRefExoticComponent<
  TimelineMiddleProps & React.RefAttributes<HTMLDivElement>
>;
export const TimelineMiddle: TimelineMiddleComponent = forwardRef<
  HTMLDivElement,
  TimelineMiddleProps
>(({ children, ...rest }, ref) => (
